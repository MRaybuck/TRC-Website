<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seminar_list.aspx.cs" Inherits="seminars_templates_seminar_list" %>
                ...
                <div id="header">
                    <nav class="navbar navbar-inverse navbar-fixed-top"
                        ...
                        <ul class="nav navbar-nav">
                            <li id="small-home">
                                <a href= "../../trc/templates/trc_index.aspx"
                                   class=" ">
                                    Home
                                </a>
                            </li>
                            <li>
                                <a href= "../../trc/templates/people.aspx"
                                   class="">
                                    People
                                </a>
                            </li>
                            <li>
                                <a href="../../trc/templates/projects.aspx"
                                   class=" ">
                                    Projects
                                </a>
                            </li>
                            <li>
                                <a href="../../trc/templates/media.aspx"
                                   class="">
                                    Media
                                </a>
                            </li>
                            <li>
                                <a href="../../trc/templates/links.aspx"
                                   class="">
                                    Links
                                </a>
                            </li>
                            ...
                            <li>
                                <a href= "../../trc/templates/contact.aspx"
                                   class="">
                                    Contact us
                                </a>
                            </li>
